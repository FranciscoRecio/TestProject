...
class AppointmentService {
    ...
    func getAppointments() {
        ...
        pastAppointments.append(Appointment(providerFirstName: "Bonnie", providerLastName: "Hudak", providerSpecialty: "Specialty C", providerId: "2562", dateAndTime: Date().addingTimeInterval(-8125473), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: true))
        ...
        futureAppointments.append(Appointment(providerFirstName: "Bonnie", providerLastName: "Hudak", providerSpecialty: "Specialist C", providerId: "2562", dateAndTime: Date().addingTimeInterval(654323), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: true))
        futureAppointments.append(Appointment(providerFirstName: "Bonnie", providerLastName: "Hudak", providerSpecialty: "Specialist C", providerId: "2562", dateAndTime: Date().addingTimeInterval(754323), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: true))
